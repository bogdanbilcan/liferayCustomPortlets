...
<%
	...
	portletURL.setParameter("jspPage", "/htro_stoc/viewFilteredStoc.jsp");
%>
...
<liferay-ui:search-container id="<%="viewFilteredStocSearch"%>" deltaConfigurable="true" iteratorURL="<%=portletURL%>"
	emptyResultsMessage="<%=noResults%>"
>
