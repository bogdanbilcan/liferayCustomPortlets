...
<%
	...
	System.out.println("keywords1 portofoliu page==> " + tipAuto);
	...
	List<PortofoliuItem> portofoliuItems = DBConnection.getInstance()
			.GetAllPortofoliuItemsOnUser(dealerIdValue);
	int listSize = portofoliuItems.size();

	PortletURL portletURL = renderResponse.createRenderURL();
	portletURL.setParameter("jspPage", "/htro_portofoliu/viewPortofoliu.jsp");
%>
...
>
	...
	<liferay-ui:search-container-results>
		<%
			results = ListUtil.subList(portofoliuItems, searchContainer.getStart(),
					...
					System.out.println("portofoliu Cur PRINT:" + searchContainer.getCur());
		%>
	</liferay-ui:search-container-results>
